      ...
      <div className="px-[30px] bg-white pt-[30px] pb-[100px] flex items-start gap-[30px]">
        ...
        <div className="">
          ...
          <div className="my-[30px]">
            ...
            <div className="flex items-center  gap-[30px] mt-[10px]">
              ...
              <div className="w-[348px] rounded-xl border border-[#D6EAFF] bg-white py-[25px] px-[30px] flex items-center gap-[10px]">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-[12px]">
                    <AiFillMinusCircle className="text-darkMain" size="20" onClick={()=>[size != 0 && setSize(prev => prev - 1)]} />
                    <p className="text-lg font-semibold">
                      {size} 
                      <span>
                         м<sup>3</sup>
                    ...
                    <AiFillPlusCircle className="text-darkMain" size="20" onClick={()=>setSize(prev => prev + 1)}/>
                  </div>
                </div>
              </div>
              ...
              <div className="w-[348px] rounded-xl border border-[#D6EAFF] bg-white py-[25px] px-[30px] flex items-center gap-[10px]">
                ...
                <div>
                  ...
                  <div className="flex items-center gap-[12px]">
                    <AiFillMinusCircle className="text-darkMain" size="20" onClick={()=> [weight != 0 && setWeight(prev => prev - 1)]}/>
                    <p className="text-lg font-semibold">{weight} кг</p>
                    <AiFillPlusCircle className="text-darkMain" size="20" onClick={()=> setWeight(prev => prev + 1)}/>
                  </div>
                </div>
              </div>
            ...
            <div className="my-[30px]">
              <div className="flex items-start gap-[30px] pb-[30px] border-b border-[#D6EAFF]">
                ...
                <div className="  box-border">
                  ...
                  <div className="box-border w-[726px]">
                      ...
                      <div className="w-full space-y-[30px]">
                        ...
                        <div className="flex items-start gap-[30px] ">
                          ...
                          <div className="w-[291px]  border-b border-[#D6EAFF] cursor-pointer bg-white py-[25px] ">
                            <div onClick={()=> setComment(prev => !prev)} className="flex items-center justify-between">
                              <p className="text-xl text-[#667582]  font-bold ">
                                Комментарии
                              </p>
                    ...
                    <button className="rounded-xl p-[17px] text-lg font-bold text-center bg-[#FFD200] mt-[30px]">Добавить адрес загрузки</button>
                  </div>
                </div>
                    ...
                    <div className="rounded-xl border mt-[10px] border-[#D6EAFF] p-[30px] flex items-start gap-[30px]">
                      <div className="w-full space-y-[30px]">
                        ...
                        <div className="flex items-start gap-[30px] ">
                          ...
                          {/* comment drop */}
                          <div className="w-[291px]  border-b border-[#D6EAFF] cursor-pointer bg-white py-[25px] ">
                            <div onClick={()=> setFinishComment(prev => !prev)} className="flex items-center justify-between">
                              <p className="text-xl text-[#667582]  font-bold ">
                                Комментарии
                              </p>
                              {finishComment ? <IoIosArrowUp /> : <IoIosArrowDown />}
                            </div>
                            {/* Drop time */}
                            <AnimatePresence>
                              {finishComment && (
              ...
              <div>
                <p className="text-2xl font-bold text-[#667582] my-[30px]">Дополнительные услуги</p>
                <div className="flex items-center gap-[10px]">
                  {['Название опции', 'lorem', 'epsum', 'simply ', 'dummy '].map(data => {
                    return <button onClick={()=> servicesHandler(data)} className={`py-[7px] px-[20px] rounded-3xl bg-[#F3F9FF] text-lg flex items-center gap-[10px] font-semibold text-[#667582] ${services.includes(data) && 'bg-darkMain text-white'} `}>{data} {services.includes(data) && <AiFillCheckCircle size='20' className="text-white"/>}</button>
                  } )}
                </div>
              </div>
            </div>
        ...
        <div className="w-full space-y-[30px]">
          <div className="border border-[#D6EAFF] rounded-xl ">
            <p className="text-[22px] font-semibold p-[30px] border-b border-[#D6EAFF] w-full">Документы</p>
            <textarea name="" id="" cols="30" rows="10" className="w-full outline-none border-none p-[30px]"></textarea>
          </div>
          <div className="border border-[#D6EAFF] rounded-xl ">
            <p className="text-[22px] font-semibold p-[30px] border-b border-[#D6EAFF] w-full">Журнал</p>
            <textarea name="" id="" cols="30" rows="10" className="w-full outline-none border-none p-[30px]"></textarea>
          </div>
        </div>
      </div>
